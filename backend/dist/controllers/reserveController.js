...
exports.getOreGradeDistribution = exports.getBoreholes = exports.calculateReserveEstimate = void 0;
const store_1 = require("../services/store");
const mlClient_1 = require("../services/mlClient");
const calculateReserveEstimate = async (req, res) => {
    try {
        ...
        const mlResponse = await mlClient_1.mlClient.estimateReserves(payload);
...
exports.calculateReserveEstimate = calculateReserveEstimate;
...
exports.getBoreholes = getBoreholes;
const getOreGradeDistribution = async (req, res) => {
    try {
        const { mineId } = req.query;
        const boreholes = await store_1.store.getBoreholes(mineId);
...
exports.getOreGradeDistribution = getOreGradeDistribution;
