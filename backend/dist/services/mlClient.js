...
class MLServiceClient {
    baseUrl;
    constructor() {
        this.baseUrl = env_1.config.ML_SERVICE_URL;
    }
    async estimateReserves(payload) {
        try {
            const response = await axios_1.default.post(`${this.baseUrl}/predict/reserves`, payload, {
                timeout: 4000
            });
    ...
    async predictShortfall(payload) {
        try {
            const response = await axios_1.default.post(`${this.baseUrl}/predict/shortfall`, payload, {
                timeout: 4000
            });
            return response.data;
        }
    ...
    async getRecommendations(payload) {
        try {
            const response = await axios_1.default.post(`${this.baseUrl}/recommendations`, payload, {
                timeout: 4000
            });
            return response.data;
        }
    ...
    async processSatellitePass(payload) {
        try {
            const response = await axios_1.default.post(`${this.baseUrl}/satellite/pass`, payload, {
                timeout: 4000
            });
            return response.data;
        }
    ...
    fallbackEstimateReserves(payload) {
    ...
    fallbackPredictShortfall(payload) {
    ...
    fallbackGetRecommendations(payload) {
        return {
            mine_id: payload.mine_id,
            mine_name: payload.mine_name,
